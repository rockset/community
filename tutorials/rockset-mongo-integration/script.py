...
def get_weather_data():
	...
	querystring = {"lat":"39.9042","lon":"116.4074","unit_system":"us","fields":"precipitation,wind_gust,humidity,wind_direction,precipitation_type,visibility,cloud_cover,cloud_base,cloud_ceiling,weather_code,feels_like,temp","apikey":WEATHER_API_KEY}
...
def get_air_pollution_data():
	...
	url = "https://api.climacell.co/v3/weather/realtime"
	querystring = {"lat":"39.9042","lon":"116.4074","unit_system":"us","fields":"o3,so2,co,no2,pm10,pm25","apikey":WEATHER_API_KEY}
...
def get_avg_pm10_results():
	r = requests.post('https://api.rs2.usw2.rockset.com/v1/orgs/self/ws/commons/lambdas/avgp10data/versions/4',
